...
const articles = [
    {
        ...
        body:
            <>
                <Button size="sm" color="blue" className="mb-2 font-mono" href="https://medium.com/@jamesowen.dev/how-to-send-email-forms-using-next-js-13-with-nodemailer-1bc9e5dd5e80">
                    Full article
                </Button>
