                    ...
                    {contactList.map((l, i) => (
                        <div className="mb-4" key={i}> {/* Add the key prop here */}
                            <a href={l.path} target="_blank">
                                <Button color="white" fullWidth={false} size="lg" className="w-64 flex items-center gap-3 font-mono " style={{ textTransform: "none" }} variant="gradient" href={l.path}>
...
//                         <Menu>
//                             <MenuHandler>
//                                 <Button color="white" fullWidth={true} size="md" className="" variant="gradient">
//                                     Email
//                                 </Button>
//                             </MenuHandler>
//                             <MenuList>
